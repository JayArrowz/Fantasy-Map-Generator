...
function reMarkFeatures() {
  ...
  console.log(cells.t);// if 1 it is a biome next to water so should be beach. -1 is marine greater than 1 they are land locked
...
function isBeach(moisture, temperature, height, cell) {
  if (cell === 1) return true; //near coast
